...
class Webapp:
    ...
    def get_real_wm_class(self) -> str:
        """Calculates the actual WM_CLASS/app_id generated by the browser for this webapp."""
        import urllib.parse
        ...
        # Get hostname (strips port numbers automatically)
        domain = parsed.hostname or ""
        
        # Get path and ensure default "/" to mirror Chromium/Vivaldi URL normalization
        path = parsed.path or "/"
        ...
        _, sub_prefix = self.get_browser_prefixes()
        return f"{sub_prefix}-{domain}_{path_clean}-Default"
